...
require_once ("application/searches/category_l3_cms_image_gallery.search.php");

class category_l3_cms_image_gallery_list extends base_list {
	...
	function get_page_details () {
		...
		$count = get_category_l3_cms_image_gallery_count ($options);
	...
	function do_search () {
		...
		$data = get_category_l3_cms_image_gallerys ($options);
