...
require_once ("application/searches/advice_l3.search.php");

class advice_l3_list extends base_list {
	private $_id;
	...
	function get_page_details () {
		...
		if (!is_null ($this->_advice_l2_id)) {
			$options['advice_l2_id'] = $this->_advice_l2_id;
		}
		...
		$count = get_advice_l3_count ($options);
