...
require_once ("application/searches/case_study_category.search.php");

class case_study_category_list extends base_list {
	private $_id;
	private $_status;
	private $_name;
	private $_url;
	...
	function get_page_details () {
		...
		$count = get_case_study_category_count ($options);
	...
	function do_search () {
		...
		$data = get_case_study_categorys ($options);
