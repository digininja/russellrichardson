...
require_once ("application/searches/advice_l2.search.php");

class advice_l2_list extends base_list {
	private $_id;
	...
	function get_page_details () {
		...
		if (!is_null ($this->_advice_l1_id)) {
			$options['advice_l1_id'] = $this->_advice_l1_id;
		}
		...
		$count = get_advice_l2_count ($options);
