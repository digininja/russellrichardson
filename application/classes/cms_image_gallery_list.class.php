...
require_once ("application/searches/cms_image_gallery.search.php");

class cms_image_gallery_list extends base_list {
	private $_id;
	private $_status;
	private $_image_id;
	private $_order_by;
	...
	function get_page_details () {
		...
		$count = get_cms_image_gallery_count ($options);
	...
	function do_search () {
		...
		$data = get_cms_image_gallerys ($options);
