...
require_once ("application/searches/case_study.search.php");

class case_study_list extends base_list {
	private $_id;
	private $_status;
	private $_name;
	...
	function get_page_details () {
		...
		if (!is_null ($this->_logo_id)) {
			$options['logo_id'] = $this->_logo_id;
		}
		...
		$count = get_case_study_count ($options);
