...
require_once ("application/searches/category_l3_linked_category_l3.search.php");

class category_l3_linked_category_l3_list extends base_list {
	...
	function get_page_details () {
		...
		$count = get_category_l3_linked_category_l3_count ($options);
	...
	function do_search () {
		...
		$data = get_category_l3_linked_category_l3s ($options);
