...
require_once ("application/searches/advice_l3_linked_advice_l3.search.php");

class advice_l3_linked_advice_l3_list extends base_list {
	...
	function get_page_details () {
		...
		if (!is_null ($this->_advice_l3_id)) {
			$options['advice_l3_id'] = $this->_advice_l3_id;
		}
		...
		$count = get_advice_l3_linked_advice_l3_count ($options);
	...
	function do_search () {
		...
		$data = get_advice_l3_linked_advice_l3s ($options);
