...
require_once ("application/searches/advice_l1.search.php");

class advice_l1_list extends base_list {
	private $_id;
	private $_name;
	private $_image_id;
	private $_summary;
	...
	function get_page_details () {
		...
		$count = get_advice_l1_count ($options);
