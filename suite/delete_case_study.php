...
$return_url = "case_studies.php?parent_id=" . $case_study->get_category_id();
$return_name = "Category";
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head profile="http://gmpg.org/xfn/11">
		<title>RR Admin Suite - Delete Case Study</title>
	...
	<body><div class="container">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?=clean_display_string ($return_url)?>"><?=clean_display_string ($return_name)?></a></li>
				<li class="breadcrumb-item active" aria-current="page">Delete Case Study</li>
			</ol>
		</nav>
			...
			<form action="<?=clean_display_string ($_SERVER['PHP_SELF'])?>" method="post">
				<fieldset>
					...
					if (!is_null ($save_result)) {
						...
						<div class="alert alert-danger" role="alert">
						<p>
							Are you sure you want to delete the following case study?
						</p>
