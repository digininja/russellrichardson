...
$return_url = "advice_l1s.php";
$return_name = "Advice";
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head profile="http://gmpg.org/xfn/11">
		<title>RR Admin Suite - Delete Advice</title>
	...
	<body><div class="container">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="/suite/advice_l1s.php">Level 1 Advice</a></li>
				<li class="breadcrumb-item active" aria-current="page">Delete Advice</li>
			</ol>
		</nav>
