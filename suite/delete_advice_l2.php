...
$return_url = "advice_l2s.php?parent_id=" . $advice_l2->get_advice_l1_id();
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head profile="http://gmpg.org/xfn/11">
		<title>RR Admin Suite - Delete Level 2 Advice Article</title>
	...
	<body><div class="container">
		...
		<h1>Delete Level 2 Advice Article</h1>

		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="/suite/">Home</a></li>
				<li class="breadcrumb-item"><a href="/suite/advice_l1s.php">Level 2 Advice Articles</a></li>
				<li class="breadcrumb-item active" aria-current="page">Delete Level 2 Advice Article</li>
			</ol>
		</nav>
				...
				<fieldset>
					...
					if (!is_null ($save_result)) {
						...
						?>
							<div class="alert alert-danger" role="alert">
						<p>
							Are you sure you want to delete the following level 2 service?
						</p>
						...
						<div id="action_button"><input type="submit" name="submit" value="Delete" /></div>
</div>
						<?php
					}
					?>
