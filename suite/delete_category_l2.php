...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	$save_result = $category_l2->delete();
} else {
...
$return_url = "category_l2s.php?parent_id=" . $category_l2->get_category_l1_id();
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head profile="http://gmpg.org/xfn/11">
		<title>RR Admin Suite - Delete Level 2 Service</title>
	...
	<body><div class="container">
		...
		<h1>Delete Level 2 Service</h1>

		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="/suite/">Home</a></li>
				<li class="breadcrumb-item"><a href="/suite/category_l1s.php">Level 2 Services</a></li>
				<li class="breadcrumb-item active" aria-current="page">Delete Level 2 Service</li>
			</ol>
		</nav>
