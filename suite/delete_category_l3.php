...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	$save_result = $category_l3->delete();
} else {
...
$return_url = "category_l3s.php?parent_id=" . $category_l3->get_category_l2_id();
$return_name = "Services";
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head profile="http://gmpg.org/xfn/11">
		<title>RR Admin Suite - Delete Level 3 Service</title>
	...
	<body><div class="container">
		...
		<h1>Delete Level 3 Service</h1>
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="/suite/">Home</a></li>
				<li class="breadcrumb-item"><a href="/suite/<?=clean_display_string ($return_url)?>">Level 3 Services</a></li>
				<li class="breadcrumb-item active" aria-current="page">Delete Level 3 Service</li>
			</ol>
		</nav>
			...
			<form action="<?=clean_display_string ($_SERVER['PHP_SELF'])?>" method="post">
				<fieldset>
					...
					if (!is_null ($save_result)) {
						...
						<div class="alert alert-danger" role="alert">
						<p>
							Are you sure you want to delete the following level 3 service?
						</p>
