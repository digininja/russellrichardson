...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head profile="http://gmpg.org/xfn/11">
		<title>RR Admin Suite - News Articles</title>
	...
	<div class="row">
		...
		<div id="main">
			<table class="table">
				...
				<tbody>
					...
					foreach ($news_articles as $news) {
						...
						?>
						<tr>
							<td><?=clean_display_string ($news->get_name())?> (<?=clean_display_string ($category->get_name())?>)</td>
							<td class="edit"><a href="edit_news.php?id=<?=clean_display_string ($news->get_id())?>">Edit</a></td>
							<td class="delete"><a href="delete_news.php?id=<?=clean_display_string ($news->get_id())?>">Delete</a></td>
						</tr>
						<?php
					}
					?>
			...
			<div id="action_button">
				<a href="edit_news.php" class="add btn btn-primary">Add News Article</a>
			</div>
		</div>
	</div>
	<?php
