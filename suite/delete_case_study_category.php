...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	$save_result = $case_study_category->delete();
} else {
...
$return_url = "case_study_categories.php";
	...
	<body><div class="container">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="/suite/case_study_categories.php">Categories</a></li>
